...
<div align="center">
  ...
  <img src="Dodge_ai/assets/1_light_overview.png" width="48%" alt="Light Mode Overview" />
  <img src="Dodge_ai/assets/2_dark_overview.png" width="48%" alt="Dark Mode Overview" />
  
  <h3>Contextual Agent Queries</h3>
  <img src="Dodge_ai/assets/4_light_query.png" width="48%" alt="Light Mode Query" />
  <img src="Dodge_ai/assets/3_dark_query.png" width="48%" alt="Dark Mode Query" />
  
  <h3>Graph Process Analysis</h3>
  <img src="Dodge_ai/assets/5_light_process_view.png" width="48%" alt="Light Mode Process Analysis" />
  <img src="Dodge_ai/assets/6_dark_process_view.png" width="48%" alt="Dark Mode Process Analysis" />
</div>
